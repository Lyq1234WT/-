		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				<div class="admin-content-body">
					<div class="am-g">
						<form class="am-form am-form-horizontal" action="addNote" target="right" method="post" style="padding-top: 30px;">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" id="startDate" name="startDate" placeholder="请输入请假开始时间" />
								</div>
							</div>
							<div class="am-form-group">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" id="length" name="length" placeholder="请输入请假时长(天)" />
								</div>
							</div>
							<div class="am-form-group">
