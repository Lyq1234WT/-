		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				<div class="admin-content-body">
					<div class="am-g">
						<form class="am-form am-form-horizontal" action="editUser" target="right" method="post" style="padding-top: 30px;">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" id="eName" placeholder="请输入用户用户名" name="ename" value="${editEmp.ename}" />
									<small>输入用户名。</small>
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" id="ePass" placeholder="请输入用户密码" name="epass" value="${editEmp.epass}" />
									<small>输入密码。</small>
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input id="realName" required="" placeholder="请输入员工姓名" value="${editEmp.realname}" name="realname" type="text">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									...
									<c:if test="${editEmp.esex==1}">
										...
										<input type="radio" name="esex" value="1" checked="checked" style="margin-left: 30px;"/> 女<br>
									</c:if>
									<small>选择性别。</small>
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input id="sal" required="" placeholder="请输底薪" value="${editEmp.sal}" name="sal" type="text">
